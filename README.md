...
## Extracting
Download ILSVRC2012_img_train.tar and run the bash script `extract_data.sh` present in the `utils` directory. This creates two directories, `train` and `val`, each with 1000 subdirectories which consist of the images from the dataset.
